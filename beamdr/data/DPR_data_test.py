...
def write_qas_query(args, pid2offset, qas_file, out_query_file):
...
def preprocess(args):
    ...
    #write_qas_query(args, pid2offset, "hotpot_train_v1.1.json", "train-query")
    write_qas_query(args, pid2offset, "hotpot_dev_fullwiki_v1.json", "dev-eval-query")
