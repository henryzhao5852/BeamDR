...
class BertForQuestionAnsweringConfidence(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids, attention_mask,
                start_positions=None, end_positions=None, switch_list=None, span_mask=None):
        ...
        if start_positions is not None and end_positions is not None and switch_list is not None:
            ...
            if self.no_masking is True:
                ...
                #span_mask = (switch_list == 0).type(torch.FloatTensor).half().to(start_positions.device)
                #span_mask = span_mask.half()
            ...
            return start_losses, end_losses, switch_losses
